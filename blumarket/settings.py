"""
Django settings for blumarket project.
...
ALLOWED_HOSTS = [
    'bluemarket.pythonanywhere.com',
    'powerful-woodland-50409.herokuapp.com',
    '127.0.0.1'
]
...
WSGI_APPLICATION = 'blumarket.wsgi.application'
